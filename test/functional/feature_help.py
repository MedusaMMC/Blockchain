...
"""Verify that starting medusa with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start medusa with -? for help text")
        ...
        self.log.info("Start medusa with -version for version information")
