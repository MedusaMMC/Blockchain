...
{
    const char* pszTimestamp = "Medusa Masternode Coin - 26 Nov 2024 - By Remapper";
...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1732648998, 639057, 0x1e0ffff0, 1, 0 * COIN);
        if(genesis.GetHash()!=uint256("0x0000074083543f6f373defe185deeb6e679edfb4bdf95c97058430efd4bf95dc"))
        {
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x0000074083543f6f373defe185deeb6e679edfb4bdf95c97058430efd4bf95dc"));
        assert(genesis.hashMerkleRoot == uint256S("0x028aefd42ab8ea5ad8685690a3648f0ef83ada867295d61ccee71f25f065a760"));
        ...
        consensus.nMaxMoneyOut = 21000000 * COIN; // 21 Million
        ...
        consensus.ZC_WrappedSerialsSupply = 0; //0 * COIN;   // zerocoin supply at height_last_ZC_WrappedSerials

        // Network upgrades
        consensus.vUpgrades[Consensus::BASE_NETWORK].nActivationHeight = Consensus::NetworkUpgrade::ALWAYS_ACTIVE;
        consensus.vUpgrades[Consensus::UPGRADE_TESTDUMMY].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_POS].nActivationHeight = 100001;
        consensus.vUpgrades[Consensus::UPGRADE_POS_V2].nActivationHeight = 100441;
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight = 100441;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight = Consensus::NetworkUpgrade::NO_ACTIVATION_HEIGHT;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight = 100541;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight = 100641;
        consensus.vUpgrades[Consensus::UPGRADE_V5_DUMMY].nActivationHeight = 100741;
...
public:
    CTestNetParams()
    {
        ...
        consensus.powLimit = ~UINT256_ZERO >> 6; // medusa starting difficulty
        consensus.posLimitV1 = ~UINT256_ZERO >> 24;
        consensus.posLimitV2 = ~UINT256_ZERO >> 20;
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 90);   // Testnet medusa addresses start with 'd'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);   // Testnet medusa script addresses start with '8' or '9'
        base58Prefixes[STAKING_ADDRESS] = std::vector<unsigned char>(1, 125); // starting with 's'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);      // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet medusa BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet medusa BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet medusa BIP44 coin type is '1' (All coin's testnet default)
