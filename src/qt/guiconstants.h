...
/* Medusa GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Medusa"
#define QAPP_ORG_DOMAIN "medusa.org"
#define QAPP_APP_NAME_DEFAULT "Medusa-Qt"
#define QAPP_APP_NAME_TESTNET "Medusa-Qt-testnet"
