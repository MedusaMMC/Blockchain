...
/** Utility functions used by the Medusa Qt UI.
 */
namespace GUIUtil
{
...
// Render MMC addresses in monospace font
...
// Parse "medusa:" URI into recipient object, return true on successful parsing
