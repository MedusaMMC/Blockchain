...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Medusa medusa-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  medusa-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded medusa transaction") + "\n" +
                               "  medusa-tx [options] -create [commands]   " + _("Create hex-encoded medusa transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded medusa transaction
