...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MMC features */
        {"medusa", "listmasternodes", &listmasternodes, true },
        {"medusa", "getmasternodecount", &getmasternodecount, true },
        {"medusa", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"medusa", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"medusa", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"medusa", "masternodecurrent", &masternodecurrent, true },
        {"medusa", "startmasternode", &startmasternode, true },
        {"medusa", "createmasternodekey", &createmasternodekey, true },
        {"medusa", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"medusa", "listmasternodeconf", &listmasternodeconf, true },
        {"medusa", "getmasternodestatus", &getmasternodestatus, true },
        {"medusa", "getmasternodewinners", &getmasternodewinners, true },
        {"medusa", "getmasternodescores", &getmasternodescores, true },
        {"medusa", "preparebudget", &preparebudget, true },
        {"medusa", "submitbudget", &submitbudget, true },
        {"medusa", "mnbudgetvote", &mnbudgetvote, true },
        {"medusa", "getbudgetvotes", &getbudgetvotes, true },
        {"medusa", "getnextsuperblock", &getnextsuperblock, true },
        {"medusa", "getbudgetprojection", &getbudgetprojection, true },
        {"medusa", "getbudgetinfo", &getbudgetinfo, true },
        {"medusa", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"medusa", "mnfinalbudget", &mnfinalbudget, true },
        {"medusa", "checkbudgets", &checkbudgets, true },
        {"medusa", "mnsync", &mnsync, true },
        {"medusa", "spork", &spork, true },
...
{
    return "> medusa-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:11911/\n";
}
